...
<html lang="en">
    ...
    <head>
        ...
        <title>ɪɴᴛᴍᴀᴛ ᴇᴅᴛᴇᴄʜ-ThankYou</title>
    </head>
    ...
    <body>
        ...
        ?>
                                ...
                                <form action="https://formsubmit.co/chiruchetan64@gmail.com" method="POST"
                                    class="row g-3">
                                    <div class="col-auto">
                    ...
                    <div class="row g-5 mb-5">
                        <div class="col-lg-4">
                            ...
                            <ul class="list-unstyled custom-social">
                                ...
                                <li>
                                    <a href="https://twitter.com/intmatedtech"><span
                                            class="fa fa-brands fa-twitter"></span></a>
                                </li>
                                <li>
