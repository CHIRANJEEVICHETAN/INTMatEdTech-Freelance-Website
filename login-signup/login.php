...
<html lang="en">
    ...
    <body>
        ...
        ?>
                            ...
                            <form method="POST" action="../login-signup/connections/login.inc.php" class="register-form"
                                id="login-form">
                                <div class="form-group">
                                    <label for="uname"><i class="zmdi zmdi-account"></i></label>
                                    <input type="text" name="uid" id="uname" placeholder="Enter Your Email/userName" />
                                </div>
                                <div class="form-group">
