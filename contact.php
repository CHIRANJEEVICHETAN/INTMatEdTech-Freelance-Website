...
<html lang="en">
    ...
    <head>
        ...
        <title>ɪɴᴛᴍᴀᴛ ᴇᴅᴛᴇᴄʜ-Contact-us</title>
    </head>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-5">
                            <div class="intro-excerpt">
                                <h1>Contact Us</h1>
                                <p class="mb-4">Get in touch with us to explore our specialized training solutions
                                    focused
                                    on empowering excellence</p>
                                <p><a href="courses.php" class="btn btn-secondary me-2">Explore</a></p>
                            </div>
                        </div>
                        <div class="col-lg-7">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="service no-shadow align-items-center link horizontal d-flex active"
                                            ...
                                            <div class="service-contents">
                                                <p><a
                                                        href="mailto:contact@intmatedtech.com">contact@intmatedtech.com</a>
                                                </p>
                                            </div> <!-- /.service-contents-->
                                        </div> <!-- /.service -->
                                    </div>
                                    ...
                                    <?php 
        if (isset($_GET["error"])) {
          if ($_GET["error"] == "emptymessagebox") {
            echo "<p>Fill in all the details and submit!!</p>";
          }
            ...
            echo "<p>Thanks you!!</p><br><p>We will contact you soon!!</>";
          }
        }
        ?>
                                </div>
                                ...
                                <form id="contactForm" method="POST" action="https://api.web3forms.com/submit">
                                    ...
                                    <input type="hidden" name="from_name" value="INTMATEdTech">

                                    <button type="submit" name="submit" class="btn btn-primary-hover-outline">Send
                                        Message</button>
                                </form>
